...
'}'
    ...
    function buildHTML() {
        ...
        trigger.className = 'tmd-chat-trigger';
        trigger.id = 'tmdChatTrigger';
        trigger.setAttribute('aria-label', 'Tech Mind Developers AI');
    ...
    function initEvents() {
        ...
        document.addEventListener('click', function(e) {
            if (state.isOpen && !win.contains(e.target) && !trigger.contains(e.target)) {
                closeChat();
            }
        });
    }
